...
public class frm_start extends javax.swing.JFrame {
   ...
   //public static String[] arrayTexto = txt_entrada.getText().indexOf(" ",1);
    ...
    private void initComponents() {
        ...
        pn_background.setBackground(new java.awt.Color(102, 102, 102));
        ...
        pn_background.add(lbl_logo, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 0, 190, 40));
        ...
        pn_background.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 70, 480, 120));

        btb_procesar.setBackground(new java.awt.Color(204, 255, 255));
        btb_procesar.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btb_procesar.setText("Procesar");
        btb_procesar.setBorder(javax.swing.BorderFactory.createEtchedBorder());
